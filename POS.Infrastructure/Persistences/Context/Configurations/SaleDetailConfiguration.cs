...
public class SaleDetailConfiguration : IEntityTypeConfiguration<SaleDetail>
{
    ...
    {
        builder.HasKey(e => e.SaleDetailId).HasName("PK__SaleDeta__70DB14FEF9089039");
        ...
        builder.HasOne(d => d.Product).WithMany(p => p.SaleDetails)
            ...
            .HasConstraintName("FK__SaleDetai__Produ__22751F6C");

        builder.HasOne(d => d.Sale).WithMany(p => p.SaleDetails)
            .HasForeignKey(d => d.SaleId)
            .HasConstraintName("FK__SaleDetai__SaleI__236943A5");
    }
}
