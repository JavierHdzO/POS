...
public class SaleConfiguration : IEntityTypeConfiguration<Sale>
{
    ...
    {
        builder.HasKey(e => e.SaleId).HasName("PK__Sales__1EE3C3FF4CC830AB");
        ...
        builder.HasOne(d => d.Client).WithMany(p => p.Sales)
            ...
            .HasConstraintName("FK__Sales__ClientId__245D67DE");

        builder.HasOne(d => d.User).WithMany(p => p.Sales)
            .HasForeignKey(d => d.UserId)
            .HasConstraintName("FK__Sales__UserId__25518C17");
    }
}
