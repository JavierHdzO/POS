...
namespace POS.Infrastructure.Persistences.Context.Configurations
{
    public class PurcharseConfiguration : IEntityTypeConfiguration<Purcharse>
    {
        ...
        {
            builder.HasKey(e => e.PurcharseId).HasName("PK__Purchars__A98C674BBF6A045D");
            ...
            builder.HasOne(d => d.Provider).WithMany(p => p.Purcharses)
                ...
                .HasConstraintName("FK__Purcharse__Provi__208CD6FA");

            builder.HasOne(d => d.User).WithMany(p => p.Purcharses)
                .HasForeignKey(d => d.UserId)
                .HasConstraintName("FK__Purcharse__UserI__2180FB33");
        }
    }
}
